...
class Job:
    def __init__(self, name="default", description="None", propeller_name="10x7E", interpolation_points=200, blade=None, observer_manager=None):
        self.name = name
        ...
        if blade is None:
            blade = Blade(self.apc_reader, None, interpolation_points)
